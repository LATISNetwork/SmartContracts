...
const publicKey1 = operatorKey1.publicKey.toEvmAddress();
console.log(publicKey1);
const publicKey2 = operatorKey2.publicKey.toEvmAddress();
console.log(publicKey2);
const publicKey3 = operatorKey3.publicKey.toEvmAddress();
...
async function main() {
  ...
  // const manufacturerContractBytecode = Buffer.from(manufacturerString);

  console.log(manufacturerContractBytecode);
  const oemContractBytecode = fs.readFileSync(
    "Smart_Contract_Binary/OEMContract_sol_OEMContract.bin"
  );
  console.log(oemContractBytecode);
  ...
  const oemContractInstantiateTx = new ContractCreateFlow()
    ...
    .setConstructorParameters(
      new ContractFunctionParameters().addString("LatisOEM")
    );
  ...
  // const manufacturerContractId = ContractId.fromString("0.0.2179869");
  // const oemContractId = ContractId.fromString("0.0.2180398");
