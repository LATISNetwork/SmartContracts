...
async function main() {
  ...
  console.log(
    "- The cost to create the smart contract is: " + contractCost + " Hbars \n"
  );
  ...
  console.log(
    `- Contract function call status: ${contractExecuteRx3.status} \n`
  );
  ...
  console.log(
    `- Contract function call status: ${contractExecuteRx4.status} \n`
  );
  ...
  console.log(
    "- The cost to call the smart contract function is: " +
      getCost +
      " Hbars \n"
  );
